...
The dataset contains supply chain operational data including:
...
- Analysed supply chain datasets containing supplier, shipment, inventory, and order information to support operational monitoring and reporting
- Developed Excel-based Purchase Order (PO) trackers and dashboards for monitoring lead times, shipping costs, inventory levels, and supplier performance
- Used Pivot Tables, slicers, charts, and KPI reporting techniques to analyse supply chain trends and identify operational bottlenecks
- Generated insights on delayed shipments, defect rates, and transportation costs to improve operational visibility and reporting efficiency
